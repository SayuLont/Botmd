...
console.log(color(figlet.textSync('MASTAH', {
...
console.log(color('Instagram :', 'cyan'), color(`@Ikyy_Ads`, 'yellow'))

console.log(color('Github :', 'cyan'), color(`@Rizkiadiaasa`, 'yellow'))

console.log(color('Wangsap :', 'cyan'), color(`085215319934`, 'yellow'))
    ...
    ky.ev.on('group-participants.update', async (anu) => {

        console.log(anu)

        try {

            let metadata = await ky.groupMetadata(anu.id)
            ...
            for (let num of participants) {
                ...
                try {
                    ...
                    ppuser = await ky.profilePictureUrl(num, 'image')
                ...
                try {
                    ...
                    ppgroup = await ky.profilePictureUrl(anu.id, 'image')
